...
@objc
 class PostResult: NSObject {
    ...
    @objc func postMethodWithParamsAndImageEmail(parameters: [String:String], forMethod: String, image: UIImage, isFront : Bool, success:@escaping SuccessBlock, fail:@escaping FailureBlock){
        let manager = Alamofire.SessionManager.default
        let headers: HTTPHeaders?
        headers =  ["Content-Type": "application/json"]
        manager.upload(
    ...
    @objc func postMethodWithParamsAndImageUpload(parameters: [String:String], forMethod: String, image: UIImage, success:@escaping SuccessBlock, fail:@escaping FailureBlock){
        let manager = Alamofire.SessionManager.default
        let headers: HTTPHeaders?
        headers =  ["Content-Type": "application/json"]
        manager.upload(
            multipartFormData: { multipartFormData in
                ...
                print(image as Any)
                let imgData = image.jpeg(.medium)
                multipartFormData.append(imgData!, withName: "image", fileName: "myImage.jpg", mimeType: "image/jpg")
